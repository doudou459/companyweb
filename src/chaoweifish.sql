...
CREATE DATABASE IF NOT EXISTS `chaoweifish` /*!40100 DEFAULT CHARACTER SET latin1 */;
USE `chaoweifish`;

-- 导出  表 chaoweifish.admin 结构
CREATE TABLE IF NOT EXISTS `admin` (
  `ID` bigint(13) NOT NULL,
  `loginID` varchar(50) CHARACTER SET latin1 NOT NULL,
  `loginKey` varchar(50) CHARACTER SET latin1 NOT NULL,
...
CREATE TABLE IF NOT EXISTS `carousel_img` (
  `ID` bigint(13) NOT NULL,
  `showType` varchar(50) CHARACTER SET latin1 NOT NULL COMMENT 'pc端或移动端',
